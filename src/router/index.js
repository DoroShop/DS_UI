...
const VendorCommissions = () =>
	import("../pages/vendor/VendorCommissions.vue");
...
const AdminCODCommissions = () =>
	import("../pages/admin/AdminCommissions.vue");
...
const AdminWithdrawals = () =>
	import("../views/admin/AdminWithdrawals.vue");
const AdminSettings = () => import("../views/admin/AdminSettings.vue");
const AdminSubscriptions = () => import("../views/admin/AdminSubscriptions.vue");
